...
cleanFun <- function(htmlString) {
  ...
  for(i in (6:3)){
    ...
    tbwords<-names(tb)
    #save 2 files for each date - one with word count and one with words in descending frequency (saved in respective folders)
    write(tb,paste0("C:/Users/Alex/Documents/R/US election prediction/PREDICTION_DATA/5_day_counts/",abs(i-8),".txt"))
    write(tbwords,paste0("C:/Users/Alex/Documents/R/US election prediction/PREDICTION_DATA/5_day_words/",abs(i-8),".txt"))
